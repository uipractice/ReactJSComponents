...
import hovCarouselIcon from '../images/hovCarouselIcon.svg';
...
return (
    ...
    <h3 className='component-type-desc'>Basic Components</h3>
      ...
      <div className='component-grid-container3'>
        ...
        <NavLink to='/carousels' className='navLink' activeClassName='navLinkActive' style={{textDecoration: 'none'}}>
          <ComponentCard 
            logoSrc={carouselIcon}
            hovLogo={hovCarouselIcon}
            title='Carousels' 
