  ...
  return (
    <div className='demo-wrapper rb-accordion-class'>
      ...
      <div style={{ width: '600px' }}>
        ...
        <div style={{ marginTop: '10px', marginBottom: '10px' }}>{`Always open`}</div>
        ...
        <div style={{ marginTop: '10px', marginBottom: '10px' }}>{`Flush accordion`}</div>
      ...
      <div className='compo-description'>
        ...
        <h5>Steps</h5>
        <ul>
          <li><strong>Step 1 :</strong> Install Dependency to your project root folder : <code>npm install react-bootstrap</code></li>
          <li><strong>Step 2 :</strong> Import components, for Accordion: <code>import Alert from 'react-bootstrap/Accordion';</code> <br /> And to use
            accordion custom toggle <code>{`import { useAccordionButton } from 'react-bootstrap/AccordionButton';`}</code></li>
